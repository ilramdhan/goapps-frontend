...
export async function GET(request: NextRequest) {
  ...
  return ppcProxy(request, "Failed to list product-machine parameters", (c, m) =>
    c.listProductMachineParameters(
      {
        page: page(sp),
        ...
        paramId: qStr(sp, "paramId", "param_id"),
...
export async function POST(request: NextRequest) {
  ...
  return ppcProxy(request, "Failed to create parameter", (c, m) => c.createProductMachineParameter(body, m))
}

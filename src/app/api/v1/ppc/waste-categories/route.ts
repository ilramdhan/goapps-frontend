...
export async function GET(request: NextRequest) {
  ...
  return ppcProxy(request, "Failed to list waste categories", (c, m) =>
    c.listWasteCategoryMasters(
      {
        page: page(sp),
...
export async function POST(request: NextRequest) {
  ...
  return ppcProxy(request, "Failed to create waste category", (c, m) => c.createWasteCategoryMaster(body, m))
}

...
import type { ListDowntimeReasonMastersParams } from "@/types/ppc/master"
import { AREA_OPTIONS, ACTIVE_FILTER_OPTIONS, AreaCode, ActiveFilter } from "@/types/ppc/common"

interface DowntimeReasonsFiltersProps {
  filters: ListDowntimeReasonMastersParams
  onFiltersChange: (filters: ListDowntimeReasonMastersParams) => void
}

export function DowntimeReasonsFilters({ filters, onFiltersChange }: DowntimeReasonsFiltersProps) {

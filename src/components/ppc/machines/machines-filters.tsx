...
import type { ListMachinesParams } from "@/types/ppc/master"
import { AREA_OPTIONS, ACTIVE_FILTER_OPTIONS, AreaCode, ActiveFilter } from "@/types/ppc/common"

interface MachinesFiltersProps {
  filters: ListMachinesParams
  onFiltersChange: (filters: ListMachinesParams) => void
}
  ...
  return (
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <DebouncedSearchInput
        ...
        placeholder="Search machine no, line..."
        debounceMs={300}

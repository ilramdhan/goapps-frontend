...
import type { ListProductMachineCapacitiesParams } from "@/types/ppc/master"

interface CapacityFiltersProps {
  filters: ListProductMachineCapacitiesParams
  onFiltersChange: (filters: ListProductMachineCapacitiesParams) => void
}

export function CapacityFilters({ filters, onFiltersChange }: CapacityFiltersProps) {
